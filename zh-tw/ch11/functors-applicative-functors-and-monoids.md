...
![](../../.gitbook/assets/whale%20%281%29.png)
...
![](../../.gitbook/assets/smug%20%281%29.png)
...
經過套用 lambda 之後我們所有的節點都會是 `Any False`。但 `mappend` 必須要至少吃到一個 `True` 才能讓最後的結果變成 `True`。這也是為什麽結果會是 `False`，因為我們樹中所有的值都小於等於 `15`。
