...
- [再来看看更多 Monad](#再来看看更多-monad)
	- [你所不知道的 Writer Monad](#你所不知道的-writer-monad)
		- [Monoids 的好处](#monoids-的好处)
	...
	- [State Monad](#state-monad)
		...
		- [随机性与 state monad](#随机性与-state-monad)
	- [Error Monad](#error-monad)
	- [一些实用的 Moandic functions](#一些实用的-moandic-functions)
		- [liftM](#liftm)
